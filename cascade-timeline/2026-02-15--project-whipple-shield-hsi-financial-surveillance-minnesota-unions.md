...
sources:
  ...
  - title: "As Minnesotans organized against ICE, DHS spied on meetings, subpoenaed bank records, court filings say"
    ...
    date: '2026-08-13'
    tier: 1
  - title: "Documents show how feds spied on protesters, left-wing organizations and unions during Metro Surge"
    url: https://minnesotareformer.com/2026/08/13/feds-spied-on-protesters-left-wing-organizations-and-unions-during-metro-surge/
    publisher: Minnesota Reformer
    date: '2026-08-13'
    tier: 1
  - title: "Homeland Security investigated Minnesota labor unions for antifa ties"
    url: https://www.washingtonexaminer.com/news/investigations/4688414/homeland-security-investigated-minnesota-labor-unions/
    publisher: Washington Examiner
    date: '2026-08-14'
    tier: 2
  - title: "Federal surveillance operation in Minnesota targeted progressive groups and unions, documents show"
    url: https://www.cbsnews.com/minnesota/news/federal-surveillance-operation-in-minnesota-targeted-progressive-groups-unions-documents/
    publisher: CBS Minnesota
    date: '2026-08-14'
    tier: 1
  - title: "Attorney General Ellison's statement on DHS surveillance of Minnesota protesters"
    url: https://www.ag.state.mn.us/Office/Communications/2026/08/14_DHS.asp
    publisher: Minnesota Attorney General
    date: '2026-08-14'
    tier: 1
  - title: "Rampage of the Surveillance State: What's Behind the Minneapolis Indictments?"
    url: https://solidarity-us.org/rampage-of-the-surveillance-state-whats-behind-the-minneapolis-indictments/
...
Roughly two weeks after opening [[2026-08-13--operation-puppet-master-hsi-infiltrates-minnesota-anti-ice-community]], Homeland Security Investigations opened a second investigation: **Project Whipple Shield**, named for the Bishop Henry Whipple Federal Building, headquarters of the federal immigration operation in Minnesota.
...
- **CWA, IFPTE, and Sunrise Movement/Sunrise Movement Education Fund** — a **single summons** (HSI-MS-2026-037704, issued 3/9/2026, served on the Clearing House Interbank Payment System per its cover sheet — Doc. 212-8) requested records for all four together: CWA (national headquarters and multiple named bank accounts — Northwest Savings Bank, United Business Bank, a Business DDA account, Truist), the **International Federation of Professional and Technical Engineers**, explicitly labeled on the summons as "(CWA)" — i.e., named as a CWA affiliate, not a separate target — and, **as two separate line items with their own address blocks**, "**Sunrise Movement Education Fund**" and "**Sunrise Movement**" (Doc. 212-8 p.3, read at 300dpi). The distinction matters: these are legally separate entities (the Education Fund a 501(c)(3), Sunrise Movement itself a 501(c)(4), with different permitted activities), and the summons names both individually rather than treating them as one target. The same summons number also drew a **second response from Fedwire** (Doc. 212-9, Federal Reserve Bank of New York letter to SA Amber Tallas, dated 4/17/2026, responding to "a Department of Homeland Security Summons dated March 9, 2026") — i.e., the identical instrument reached two separate payment-clearing systems, not CHIPS alone as this entry previously stated. Fedwire's own search-term log confirms **positive hits** on both `*SUNRISEMOVEMENTEDUCATIONFUND*` and `*SUNRISEMOVEMENT* AND (WASHINGTON* OR DC* OR WDC*)` — meaning wire-transfer records for both entities were located and produced, not merely requested. The summons's own language requests **"any and all records"** on these entities from January 1, 2023 through March 9, 2026 — not a request narrowed to "donations and PAC spending." No PAC-specific or donation-specific framing appears on the face of the document; that characterization does not trace to the primary summons and has been removed.
...
Eighteen distinct organizations — a labor federation, a teachers' local, a veterans' group, a racial-justice group, a bicycle repair collective — rendered as spokes in a chart titled "The Conspiracy," under a government seal, shown to the body that decides whether to indict. **Sunrise Movement is not among the 18** — a direct visual read of Doc. 212-3 at 300dpi (2026-08-13 pass) found neither Sunrise Movement nor Sunrise Movement Education Fund on the chart. Sunrise's presence in this record is confined to the financial-summons instrument and to the surveillance narrative below; it was not presented to the grand jury as a node in HSI's own conspiracy diagram.
...
- Which financial institutions complied and whether any refused or notified their customers — **checked 2026-08-20, updated 2026-08-28**: no evidence found of any recipient organization notifying individual members/donors that their records were reviewed. HSI's own ROIs confirm FedWire and PayPal/Venmo *did* comply and produce records (212-5, 212-10). **Correction**: Doc. 212-9 is a **second Fedwire** response (Federal Reserve Bank of New York, 4/17/2026), not a CHIPS response as this entry previously stated — it answers the identical summons number (HSI-MS-2026-037704) that Doc. 212-8's cover sheet shows served on CHIPS, meaning the same instrument reached two payment-clearing systems. Fedwire's response confirms **positive search-term hits** for both `SUNRISEMOVEMENTEDUCATIONFUND` and `SUNRISEMOVEMENT`, i.e. records for both entities were located and produced, not merely requested. Whether CHIPS itself (the entity actually served per 212-8's cover sheet) separately produced records is still not confirmed in this document set — its response letter, if any, was not located among 212-1 through 212-31.
- The statutory authority claimed for the administrative summonses, and whether it supports records unrelated to customs or immigration violations — **resolved 2026-08-28**: 19 U.S.C. § 1509 (Tariff Act of 1930 § 509, as amended), stated on the face of the FedWire and CHIPS-directed summons forms themselves (Doc. 212-6, 212-8). This is customs-summons authority with no customs nexus stated on the form for a domestic-terrorism-financing theory — the statutory mismatch itself is now documented, not just suspected. Whether a court would sustain that authority for this use remains untested; no challenge has been located.
...
- What predicate, if any, brought Sunrise Movement onto the CWA/IFPTE summons — **resolved as a negative, 2026-08-28**: no predicate is stated anywhere in the reviewed ROI set. Neither case-opening ROI (212-1, 212-2) names any organization; the one ROI with substantive Sunrise Movement content (212-11) describes a public training HSI's own agent says "focused on 'peaceful' protests," with the only "direct-action" language volunteered by HSI's own undercover agent to an unnamed attendee, not attributed to Sunrise Movement or its staff. Sunrise Movement also does not appear on the "Conspiracy" grand jury exhibit (Doc. 212-3, confirmed 2026-08-13). This is a documented absence, not a proven absence of any predicate that exists elsewhere in the file (grand jury transcript excerpts 212-4/212-27 were not read in full, see [[us-v-sant-0-26-cr-00115-doc-212-full-roi-set]] remaining gaps).
