...
At approximately 1745 hours on April 8, 2026 — fifteen minutes before a publicly advertised talk was to begin — a Homeland Security Investigations undercover agent entered the sanctuary of Zion Lutheran Church at 1501 West Liberty Street in Ann Arbor, Michigan, wearing a recording device.

The resulting Report of Investigation, filed under seal in the District of Minnesota and unsealed August 13, 2026, is unusual in one respect that most reporting on the Minnesota surveillance has not emphasized: **its accountability block is not redacted.** The attendees' names are blacked out. The agents' names are not.

- **REPORTED BY**: Erin Herrgott, Special Agent
- **APPROVED BY**: Darryl Pugh, Resident Agent in Charge
- **DATE APPROVED**: April 13, 2026

## What Happened / Key Facts

**The tasking chain.** Per the ROI synopsis, on April 6, 2026, HSI Detroit Metro Airport received a collateral investigation request from the **HSI Special Agent in Charge of Saint Paul, Minnesota** — a third accountability node, identified by position but not by name in this document. Saint Paul requested "local support for Undercover Operatives to attend an event in Ann Arbor," asserting the event "is believed to be linked to the ongoing investigation of suspects involved in violations of 18 USC 111 and 18 USC 372" (assaulting/impeding a federal officer; conspiracy to impede).

The case was opened **April 7 — one day before the event**. Request to church pew took two days.
...
One presenter, recalling an incident in which ICE agents were "allegedly" attacked with a shovel, "stated something to the effect of how she wished someone would attack ICE agents with a shovel." The agent's own hedges — *allegedly*, *something to the effect of* — fence the single arguably chargeable utterance in the report. It is a wish, expressed at a public meeting, recorded by a hedging witness.

**The collection basket.** The presenters passed a basket asking for donations to fund their travel. "UCA 9759 received the basket and observed multiple cash donations within the basket and a piece of paper that contained a QR code," and the associated URL was recorded into the report (redacted in the filed copy). A church collection basket, passed hand to hand, was inventoried into a federal investigative file. This is not incidental: [[project-whipple-shield]] is the financial arm of the same investigation, which used administrative summonses — no warrant, no judge — to obtain years of SEIU and CWA records and PayPal and Venmo transactions for Voices for Racial Justice.

**An attendee written up for advertising a protest in Romulus.** "One of the attendees, a younger female, took the opportunity to advertise a weekly anti-ICE protest in the Romulus area." She spoke at a public meeting and entered a federal investigative file.

Romulus is not an arbitrary Detroit suburb. On February 4, 2026, DHS bought a ~250,000-square-foot warehouse at **7525 Cogswell Street, Romulus** for **$34.7 million**, to convert into a 500-detainee ICE facility. Michigan AG Dana Nessel had demanded ICE halt the plan on February 27 and sought transparency on March 5; on **March 24 — fifteen days before this church operation** — the City of Romulus and the State of Michigan jointly sued DHS in the Eastern District of Michigan (Case 2:26-cv-10968-JJCG-EAS) to block it. See [[2026-03-24--michigan-romulus-sue-ice-dhs-detention-warehouse]].

So the weekly protest this attendee advertised was almost certainly directed at a detention facility the State of Michigan was actively suing to stop. An HSI agent, tasked from Saint Paul under a conspiracy predicate, recorded her doing so — which means the federal file now contains a note that someone publicized lawful protest against a federal acquisition then under challenge by that state's own attorney general.
...
Neither Herrgott nor Pugh has a discoverable public profile as of this entry. Their names are public solely because a defense attorney moved to unseal the discovery in *United States v. Sant et al.*

**The legal exposure is specific, and the injunction did not reach this building.** Defense attorney Kevin Riach argues the surveilled parties "were engaging in First Amendment-protected activities" and that the investigation is "unlikely to withstand scrutiny."

On February 13, 2026 — eight weeks before this operation — Judge F. Dennis Saylor IV granted a preliminary injunction in *New England Synod, ELCA v. DHS*, 4:25-cv-40102 (D. Mass.), finding plaintiffs likely to succeed on their RFRA claim: the January 20, 2025 rescission of the sensitive-locations policy substantially burdens religious exercise by discouraging attendance, and is not the least restrictive means of enforcing immigration law. The order bars warrantless enforcement inside plaintiff churches, at their entrances, on adjacent property, within 100 feet of entrances, and bars checkpoints to interrogate people traveling to or from them.

**Relief is limited to the named plaintiff organizations and their identified facilities.** The ELCA plaintiffs are five synods: New England, Greater Milwaukee, Southwest California, Southwest Texas, and Sierra Pacific. Zion Lutheran is ELCA but sits in the **Southeast Michigan Synod, which is not a plaintiff** — so the injunction did not apply to 1501 West Liberty Street. University Baptist in Minneapolis, which was covered, has filed statements with the court noting the injunction should have blocked DHS activity on its property.

That distinction is the finding, not a technicality. A federal court has held this policy likely violates RFRA. The holding protects only those congregations whose denominational bodies happened to sue. Same denomination, same policy, same conduct, different synod — and the conduct in Ann Arbor may have been lawful for no better reason than that no court had yet been asked about that particular building.
...
- The identity of the HSI Special Agent in Charge, Saint Paul who originated the collateral request
- Whether the other 21 "Breaking the ICE" tour stops drew comparable collateral tasking
- Whether Herrgott or Pugh appear in other ROIs in this discovery set
- Whether UCA 9759 is the same undercover agent reported by The Intercept as having offered to "build items" for direct action to a Sunrise organizer after a January 31 training
- Whether Zion Lutheran or the Southeast Michigan Synod has taken or is considering legal action
- The remaining page of this ROI (page 3 of 3) and the rest of the ~30 unsealed reports
