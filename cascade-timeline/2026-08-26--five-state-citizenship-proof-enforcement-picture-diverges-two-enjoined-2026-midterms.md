...
sources:
  - title: "States Already Enacting Harmful SAVE Act Policies, Requiring Proof of Citizenship to Vote"
    ...
    date: '2026-04-23'
    tier: 1
  - title: "Federal judge blocks enforcement of Ohio proof-of-citizenship requirement for voter registration"
    ...
    date: '2026-08-26'
    tier: 1
  - title: "Ahead of midterms, federal court strikes down NH proof-of-citizenship voter registration law"
    url: https://newhampshirebulletin.com/2026/05/29/ahead-of-midterms-federal-court-strikes-down-nh-proof-of-citizenship-voter-registration-law/
    publisher: New Hampshire Bulletin
    date: '2026-05-29'
    tier: 1
  - title: "VICTORY: Court Declares NH Anti-Voter Law Unconstitutional"
    url: https://www.aclu-nh.org/press-releases/victory-court-declares-nh-anti-voter-law-unconstitutional/
    publisher: ACLU of New Hampshire
    date: '2026-05-29'
    tier: 2
  - title: "State of South Dakota faces lawsuit over proof-of-citizenship voter registration law"
    ...
    publisher: South Dakota Searchlight
    date: '2026-08-24'
    tier: 1
  - title: "More than 5,000 Utah voters need to provide proof of citizenship under new state law"
    url: https://utahnewsdispatch.com/2026/05/27/5000-utah-voters-need-to-provide-proof-of-citizenship-under-new-state-law/
    publisher: Utah News Dispatch
    date: '2026-05-27'
    tier: 1
  - title: "Judge Dismisses Challenge to Wyoming Proof of Citizenship Law, Leaving Barriers for Voters in Place"
    url: https://www.democracydocket.com
    publisher: Democracy Docket
    date: '2025-07-22'
    tier: 2
  - title: "U.S. Election Assistance Commission — Operations in the Absence of Commissioners, August 2026"
    url: https://www.eac.gov/sites/default/files/2026-08/Commission_Operations_in_the_Absence_of_Commissioners_August_2026.pdf
...
- **Arizona** — EFFECTIVE. Longest-running of the five; in place for over 20 years, predating the 2026 wave. Only state that had built the "bifurcated" federal-only-ballot infrastructure before 2025.
...
**Net effect for the 2026 midterms**: of the Brennan Center's actual five-state list, three (Arizona, South Dakota, Wyoming) are in force without an operative injunction; one (New Hampshire) is enjoined statewide; and Utah is in force under its bifurcated system. Ohio's separate, narrower BMV requirement — the state that had displaced Arizona in the version of this fact that reached this corpus — is now also enjoined as of the write date.

## The ~21 Million Figure

The Brennan Center's own report states: "Our research shows that 21 million American citizens lack ready access to these documents" (i.e., a U.S. passport, birth certificate, or equivalent), in a passage explaining the stakes if the *federal* SAVE Act becomes law. This is the Brennan Center's own national estimate of documentary-access gaps — not a per-state or per-statute count, and not an estimate of how many registrants any one of the five state laws above will actually reject (the state-level numbers documented above — Utah's 5,000 flagged / 27 confirmed noncitizens, South Dakota's ~1,500 federal-only registrations — are orders of magnitude smaller and measure a different thing: actual administrative outcomes under state law, not the national population lacking documents). Citing the 21 million figure as a state-enforcement casualty count would repeat the combined-estimate-attribution error this ticket was instantiated to avoid.
...
Confirmed still headless. Per the EAC's own August 2026 operations memo: "Effective July 9, 2026, the U.S. Election Assistance Commission (EAC or Commission) has no members appointed," following the firing/removal of Hicks, Hovland, and McCormick (Commissioner Palmer had resigned April 30, 2026). Under HAVA, most Commission actions require at least three of four members' approval; the memo enumerates what may proceed by staff delegation (certification testing, grant disbursement, EAVS survey administration) versus what cannot (adoption of new policy, modification of the National Mail Voter Registration Form or State-Specific Instructions, new VVSG standards, accreditation actions). No quorum has been restored as of this writing.
...
- [[2026-02-11--save-america-act-passes-house]] — first House passage, 218-213
- [[2026-05-04--dhs-save-voter-roll-purge-blitz-ohio-texas-idaho-2026-midterms]]
- [[2013-01-01--kansas-kobach-proof-citizenship-interstate-crosscheck]]
- [[leads-harvested-daily-capture-2026-08-27]] — instantiating lead, corrected here
